...
function testAmzDatetime() {
  ...
  if (amzDatetime !== expected) {
    throw (
      'Amazon date time was not created correctly.\n' +
      'Actual:   [' +
      amzDatetime +
      ']\n' +
      'Expected: [' +
...
function testEightDigitDate() {
  ...
  if (eightDigitDate !== expected) {
    throw (
      'Eight digit date was not created correctly.\n' +
      'Actual:   ' +
      eightDigitDate +
      '\n' +
      'Expected: ' +
...
function testPad() {
  ...
  if (padSingleDigit !== expected) {
    throw (
      'Single digit 3 was not padded with leading zero.\n' +
      'Actual:   ' +
      padSingleDigit +
      '\n' +
      'Expected: ' +
...
function testAreAllEnvVarsSet() {
  ...
  function testAreAllEnvVarsSetStringArrayNotFound() {
    ...
    const keys = [
      'UNKNOWN_ENV_VAR_KEY_1',
      'UNKNOWN_ENV_VAR_KEY_2',
      'UNKNOWN_ENV_VAR_KEY_3',
    ];
    const actual = utils.areAllEnvVarsSet(keys);
    if (actual) {
